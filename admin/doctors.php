        ...
        <div class="content container-fluid" style=" background: #021a7b2e;">
            ...
            <div class="page-header">
                ...
                <div class="col-12 text-right">
                    <a href="adddoctors.php" class="btn btn bg-danger-light"><i class="fas fa-plus"></i>Add
                        Doctors</a>
                </div>
            </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table table-hover table-center mb-0 datatable">
                                    ...
                                    <tbody>
                                        <?php
                                            $sql = "SELECT * FROM doctorlist ORDER BY doctorlist.id DESC";
                                        ...
                                        <tr style="    text-align: justify;">
                                            ...
                                            <td class="text-right">
                                                <div class="actions">
                                                    ...
                                                    <a href="deletedoctor.php?id=<?php echo  $row["id"] ?>"
