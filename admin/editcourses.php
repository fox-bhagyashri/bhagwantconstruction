...
$sql = "UPDATE `addcourses` SET `image`=CONCAT('uploads/', '$filename') WHERE id = '$idd'";
//echo "<br>-=-=-=-=-=-<br>".$sql;
  if ($conn->query($sql)) {
    ...
    <div class="main-wrapper">
        ...
        <div class="page-wrapper">
            <div class="content container-fluid">
                    ...
                    <div class="row align-items-center">
                        <div class="col">
                            ...
                            <ul class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">Edit Courser</li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                $sql1 = "SELECT * FROM addcourses WHERE id= $id";
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-sm-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea type="text" style="height:222px;" class="form-control"
                                                    name="description"
                                        ...
                                        <div class="col-12 col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" name="singleline"
                                                    required><?php echo $row['single_line']; ?></textarea>
                                            </div>
                                        </div>
