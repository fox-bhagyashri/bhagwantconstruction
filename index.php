    ...
    <div class="page-wrapper">
            ...
            <div class="sidebar-inner">
                <div class="upper-box">
                    ...
                    <div class="content-box">
                        ...
                        <div class="text">our clients, oue employees, and our community through our commitmrnt to
                            leadership, excellence in craft, and attention to detail.</div>
        ...
        <section class="slider-one">
            <div class="main-slider swiper-container">
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                        <div class="slider-one_image-layer" style="background-image:url(assets/images/14724.jpg)"></div>
                        <div class="slider-one_pattern"
                            style="background-image:url(assets/images/main-slider/vector-1.png)"></div>
                            ...
                            <div class="slider-one_content">
                                <div class="slider-one_content-inner">
                                    ...
                                    <div class="slider-one_arrow"
                                        style="background-image:url(assets/images/main-slider/vector-2.png)"></div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <!-- Slide -->
                    <div class="swiper-slide">
                        <div class="slider-one_image-layer" style="background-image:url(assets/images/8760.jpg)"></div>
                        <div class="slider-one_pattern"
                            style="background-image:url(assets/images/main-slider/vector-1.png)"></div>
                        <div class="auto-container">
                            <!-- Content Column -->
                    ...
                    <!-- Slide -->
                    <div class="swiper-slide">
                        <div class="slider-one_image-layer" style="background-image:url(assets/images/8790.jpg)"></div>
                        <div class="slider-one_pattern"
                            style="background-image:url(assets/images/main-slider/vector-1.png)"></div>
                        <div class="auto-container">
                            <!-- Content Column -->
            ...
            <!-- <div class="slider-two_options">
                <div class="button">
                    <a class="service-btn" href="#">More About Us <i class="fa-arrow-right"></i></a>
                </div>
                        ...
                        <div class="about-one_image-outer">
                            <div class="row clearfix">
                                ...
                                <div class="column col-lg-8 col-md-6 col-sm-6">
                                    <div class="image">
                                        <img src="assets/images/company/WhatsApp Image 2025-07-26 at 4.30.23 PM (9).jpeg"
                                            alt="" />
                                    </div>
                                </div>
                            </div>
        ...
        <section class="service-one">
            <div class="service-one_shadow"
                style="background-image:url(assets/images/background/service-one_shadow.png)"></div>
            <div class="auto-container">
                            ...
                            <div class="service-one_content-outer">
                                ...
                                <div class="service-one_titles">
                                    ...
                                    <div class="service-one_title active">
                                        <h4 class="service-one_heading"><a href="#">Commercial
                                                Construction</a></h4>
                                        <a class="service-one_arrow" href="#">
                                            <i class="fa-classic fa-solid fa-arrow-right fa-fw"></i>
                                        </a>
                                    </div>
                                    <!-- Two -->
                                    <div class="service-one_title">
                                        <h4 class="service-one_heading"><a href="#">Residential
                                                Construction</a></h4>
                                        <a class="service-one_arrow" href="#">
                                            <i class="fa-classic fa-solid fa-arrow-right fa-fw"></i>
                                        </a>
                                    ...
                                    <!-- Three -->
                                    <div class="service-one_title">
                                        <h4 class="service-one_heading"><a href="#"> Civil Turnkey Projects
                                            </a></h4>
                                        <a class="service-one_arrow" href="#">
                                            <i class="fa-classic fa-solid fa-arrow-right fa-fw"></i>
                                        </a>
                                    ...
                                    <!-- Four -->
                                    <div class="service-one_title">
                                        <h4 class="service-one_heading"><a href="#">Sports Infrastructure Development
                                            </a></h4>
                                        <a class="service-one_arrow" href="#">
                                            <i class="fa-classic fa-solid fa-arrow-right fa-fw"></i>
                                        </a>
                                    ...
                                    <!-- Five -->
                                    <div class="service-one_title">
                                        <h4 class="service-one_heading"><a href="#">Bridges & Flyovers
                                            </a></h4>
                                        <a class="service-one_arrow" href="#">
                                            <i class="fa-classic fa-solid fa-arrow-right fa-fw"></i>
                                        </a>
                                    ...
                                    <!-- Six -->
                                    <div class="service-one_title">
                                        <h4 class="service-one_heading"><a href="#">Roads & Highways</a></h4>
                                        <a class="service-one_arrow" href="#">
                                            <i class="fa-classic fa-solid fa-arrow-right fa-fw"></i>
                                        </a>
                                    </div>
                                ...
                                <div class="service-one_images_outer">
                                        ...
                                        <div class="service-one_content">
                                            ...
                                            <div class="service-one_button">
                                                <a href="#" class="theme-btn btn-style-three">
                                                    <span class="btn-wrap">
                                                        <span class="text-one">Discover More <i><img
                                                                    src="assets/images/icons/arrow-1.svg"
                                                                    alt="" /></i></span>
                                                        <span class="text-two">Discover More <i><img
                                                                    src="assets/images/icons/arrow-1.svg"
                                                                    alt="" /></i></span>
                                                    </span>
                                                </a>
                                    ...
                                    <div class="service-one_image five">
                                        ...
                                        <div class="service-one_content">
                                            ...
                                            <h3 class="service-one_sub-title"> Bridges & Flyovers
                                            </h3>
                                            <div class="service-one_text">We deliver engineering excellence in the
                                                construction of bridges and flyovers. Our solutions are designed to
                                                alleviate traffic congestion and optimize transit efficiency.</div>
                                        </div>
                                    </div>
                                    <!-- Image -->
                                    <div class="service-one_image six">
                                        ...
                                        <div class="service-one_content">
                                            ...
                                            <h3 class="service-one_sub-title">Roads & Highways
                                            </h3>
                                            <div class="service-one_text">We specialize in the construction and
                                                development of robust road and highway networks. Our projects, from
                                                high-capacity expressways to essential rural access roads</div>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="row clearfix">
                    ...
                    <div class="counter-block_one col-lg-3 col-md-6 col-sm-12">
                        <div class="counter-block_one-inner wow fadeInLeft" data-wow-delay="0ms"
                            ...
                            <div class="counter-block_one-count"><span class="odometer"
                                    data-count="3"></span>K<sup>+</sup></div>
                    ...
                    <div class="counter-block_one col-lg-3 col-md-6 col-sm-12">
                        <div class="counter-block_one-inner wow fadeInLeft" data-wow-delay="0ms"
                            ...
                            <div class="counter-block_one-outline"></div>
                            <div class="counter-block_one-count"><span class="odometer"
                                    data-count="2"></span>K<sup>+</sup></div>
                        ...
                        <div class="row clearfix">
                            ...
                            <div class="info-block_one col-lg-6 col-md-6 col-sm-6">
                                <div class="info-block_one-inner">
                                    ...
                                    CTS No.4702, Office No-210, Bramha Sky Uzuri, Near Dr. Babasaheb Ambedkar Chowk,
                                    Pimpri, Pune-411018.
                                </div>
                            </div>
                        ...
                        <div class="contact-form">
                            <form method="post" action="#" id="contact-form">
                                <div class="row clearfix">
                                    ...
                                    <div class="form-group">
                                        <div class="d-flex justify-content-between align-items-end flex-wrap">
                                            <!-- <div class="contact-form_text">We're excited to connect with you! <br>
                                                Required fields are marked *</div> -->
                                            <!-- Button Box -->
                                            <button class="theme-btn btn-style-three">
                                                <span class="btn-wrap">
                                                    <span class="text-one">Contact Now <i><img
                                                                src="assets/images/icons/arrow-1.svg"
                                                                alt="" /></i></span>
                                                    <span class="text-two">Contact Now <i><img
                                                                src="assets/images/icons/arrow-1.svg"
                                                                alt="" /></i></span>
                                                </span>
                                            </button>
